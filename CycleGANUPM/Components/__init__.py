...
from CycleGANUPM.Components.data.datasets import DirectorioDatasetConCarpetas, DirectorioDatasetSinCarpetas
from CycleGANUPM.Components.data.transforms import get_transform
